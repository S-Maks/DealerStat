package com.dealerStat.store.exception.handler;

import com.dealerStat.store.exception.AbstractInvalidDataException;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {ConvertingException.class})
